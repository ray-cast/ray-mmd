...
Alpha:
----------------
　　It has no effect on opaque objects, because of each tab is independent of others and each tab will fetched the alpha value from .PMX model, it won't affects all of the other tabs, and if you modified this entry you should also edit the `main.fx` at the the time.
