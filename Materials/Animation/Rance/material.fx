...
#define EMISSIVE_MAP_ANIMATION_ENABLE 1 // 指定图片是GIF/APNG时启用 (ALBEDO_MAP_IN_TEXTURE 必须为 0)
...
#define EMISSIVE_MAP_FILE "rance.gif"
