...
float4  MaterialDiffuseOrig     : DIFFUSE  < string Object = "Geometry"; >;
...
static float4 MaterialDiffuse = float4(saturate((MaterialDiffuseOrig.rgb + MaterialEmissiveOrig.rgb)), MaterialDiffuseOrig.a);
