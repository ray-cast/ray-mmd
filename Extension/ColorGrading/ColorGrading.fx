...
static float3 mColorOffsetAll     = lerp(lerp(0.0, 3.0, mColorOffsetAllP), 0, mColorOffsetAllM);
...
static float3 mColorOffsetLow     = lerp(lerp(0.0, 3.0, mColorOffsetLowP), 0, mColorOffsetLowM);
...
static float3 mColorOffsetMid     = lerp(lerp(0.0, 3.0, mColorOffsetMidP), 0, mColorOffsetMidM);
...
static float3 mColorOffsetHigh     = lerp(lerp(0.0, 3.0, mColorOffsetHighP), 0, mColorOffsetHighM);
	...
	float3 colorGainM)
{
	...
	color = color * (colorGainP.rgb + colorGainM.rgb);
	return color;
}
